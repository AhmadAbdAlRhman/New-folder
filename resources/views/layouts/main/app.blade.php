...
<head>
    ...
    @stack('topcss')
    @if(app()->getLocale() == 'ar')
        <link rel="stylesheet" href="{{ asset('assets/css/rtl/argon.css') }}" type="text/css">
        <link rel="stylesheet" href="{{ asset('assets/css/rtl/custom.css') }}" type="text/css">
    @else
...
@endif
<script src="{{ asset('assets/lang/ar.js') }}"></script>
</body>
</html>
