    ...
    <div class="col-xl-3 col-md-6">
        <div class="card card-stats">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col">
                        <h5 class="card-title text-uppercase text-muted mb-0">{{ __('Messages Used') }}</h5>
                        <span class="h2 font-weight-bold mb-0" id="total-messages-used"><img src="{{ asset('uploads/loader.gif') }}"></span> / <span class="h2 font-weight-bold mb-0" id="total-messages-limit"><img src="{{ asset('uploads/loader.gif') }}"></span>
                    </div>
                    <div class="col-auto">
