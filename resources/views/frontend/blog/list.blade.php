                     ...
                     <article class="postbox__item format-image mb-50 transition-3">
                        ...
                        <div class="postbox__content">
                           <div class="postbox__meta">
                              ...
                              <span><a href="{{ url('/blogs?date='.$blog->created_at->translatedFormat('d-m-Y')) }}"><i class="fal fa-clock"></i> {{ $blog->created_at->translatedFormat('F d,Y') }}</a></span>
                           ...
                           <div class="sidebar__post rc__post">
                              ...
                              <div class="rc__post mb-20 d-flex">
                                 ...
                                 <div class="rc__post-content">
                                    <div class="rc__meta">
                                       <span>{{ $recent_blog->created_at->translatedFormat('d F, Y') }}</span>
                                    </div>
